...
<div class="content">
<s:form id="reportListForm" action="/report/reportAccountList.action">
	...
	<table class="report" borderColor="#f2f2f2" border="1">
		<tr>
			<td align="center" colspan="10" width="80%" class="green-bg1" colspan="5"><h1>账户级别SEM业务报表</h1></td>
		</tr>
		<tr>
			<td align="right" colspan="10">
				<report:pages action="reportAccountList.action" excel="reportAccountList!excelOutput.action" page="${page}"/>
			</td>
		</tr>
		<tr align="center">
		...
		<tr>
			<th width="5%"><report:tableTitle title="账户名" action="reportAccountList.action" sqlName="col_1_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%"><report:tableTitle title="搜索" action="reportAccountList.action" sqlName="col_2_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%"><report:tableTitle title="网盟" action="reportAccountList.action" sqlName="col_3_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%">媒体费</th>
			<th width="12%"><report:tableTitle title="达闻媒体费" action="reportAccountList.action" sqlName="col_4_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%"><report:tableTitle title="达闻成本" action="reportAccountList.action" sqlName="col_5_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%"><report:tableTitle title="达闻折扣" action="reportAccountList.action" sqlName="col_6_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%"><report:tableTitle title="服务费" action="reportAccountList.action" sqlName="col_7_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%"><report:tableTitle title="收入" action="reportAccountList.action" sqlName="col_9_0_" page="${page}" ctx="${ctx}"/></th>
			<th width="12%"><report:tableTitle title="毛利" action="reportAccountList.action" sqlName="col_10_0_" page="${page}" ctx="${ctx}"/></th>
		</tr>
